...
REM python examples/generic_api/project_setup.py --urls "%BASE_PROD_URL%" --token=%TOKEN_PROD% --filter=2b3a9564 --signing_key="D:/ansysDev/signing_prod.key"
python examples/generic_api/project_setup.py --urls "%BASE_PROD_URL%" --token=%TOKEN_PROD% --signing_key="D:/ansysDev/signing_prod.key"
