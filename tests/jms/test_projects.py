...
class ProjectsTest(REPTestCase):
    ...
    def test_project_copy(self):
        ...
        copied_proj1 = root_api.get_project(name=tgt_name)
        self.assertIsNotNone(copied_proj1)

        tgt_name = proj_name + "_copy2"
        project_api.copy_project(tgt_name)
        copied_proj2 = root_api.get_project(name=tgt_name)
        self.assertIsNotNone(copied_proj2)

        # Delete projects
        root_api.delete_project(copied_proj1)
        root_api.delete_project(copied_proj2)
        root_api.delete_project(proj)
    ...
    def test_project_archive_restore(self):
        ...
        project.priority = 6
        project = root_api.update_project(project)
        ...
        with tempfile.TemporaryDirectory() as tpath:
            ...
            # Restore project
            restored_project = root_api.restore_project(archive_path, restored_proj_name)
        ...
        root_api.delete_project(project)
        root_api.delete_project(restored_project)
