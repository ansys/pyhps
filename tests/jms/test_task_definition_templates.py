...
from ansys.rep.client.jms.schema.task_definition_template import \
...
class TaskDefinitionTemplateTest(REPTestCase):
    ...
    def test_template_deserialization(self):
        ...
        json_data = {
                    ...
                    "data": {
                        "execution_command": "%executable% -b nolist -i %file:dat% -o %file:out% -np %num_cores% -dis -s noread -p ansys",
