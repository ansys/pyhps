...
def main():
    ...
    client = Client(rep_url="https://dcsv202testing.westeurope.cloudapp.azure.com/dcs", username="repadmin", password="An5y5_repadmin")
    ...
    for wbjn in wbjn_files:
        ...
        job_def.add_parameter_mapping(key_string='number_of_cores', tokenizer="=", task_definition_property="num_cores", file_id=wbjn.id)
