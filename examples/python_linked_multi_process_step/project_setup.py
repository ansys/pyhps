...
from ansys.rep.client.jms import (Client, File, FitnessDefinition,
                                  ...
                                  ParameterMapping, Project, SuccessCriteria, ResourceRequirements, Software,
                                  TaskDefinition)
...
def main(client, num_task_definitions, num_jobs, start, inactive):
    ...
    files.append(File(name='input', evaluation_path="input.json",
    ...
    for i in range(num_task_definitions):
        ...
        files.append(File(name=f"td{i}_result",
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--inactive',  action='store_true',
