...
python examples/generic_api/project_setup.py --urls "%BASE_URL%"  --filter=032FPostHAnfo6br5KBd0H --verbose true --token=%TOKEN% --accounts "%ACCOUNT_BURST%" --monitor True
REM --filter=BucklingLoadTest
REM --limited_monitor True
REM --accounts "%ACCOUNT_BURST%" "%ACCOUNT_TOASTER%" --verbose=true
