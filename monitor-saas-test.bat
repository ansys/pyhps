...
python examples/generic_api/project_setup.py --urls "%BASE_URL%"  --token=%TOKEN% --verbose=true --limited_monitor True --remove=old --signing_key="D:/ansysDev/signing.key"
