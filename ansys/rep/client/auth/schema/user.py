...
class UserSchema(BaseSchema):
    ...
    id = fields.String(load_only=True, description="Unique user ID, generated internally by the server on creation.")
    ...
    realm_roles = fields.Str(dump_only=True, many=True, description="Realm roles assigned to the user")
    is_admin = fields.Function(deserialize=_check_admin, description="Whether the user has admin rights or not.")
