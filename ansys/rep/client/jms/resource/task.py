# autogenerated on 2022-09-01 17:37 based on TaskSchema
...
class Task(Object):
    ...
    Parameters:
        ...
        input_file_ids (list[str]): List of IDs of input files of task.
        output_file_ids (list[str]): List of IDs of output files of task.
        inherited_file_ids (list[str]): List of IDs of inherited files of task.
        owned_file_ids (list[str]): List of IDs of owned files of task.
