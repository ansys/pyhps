...
class Job(Object):
    ...
    def get_tasks(self, as_objects=True, **query_params):
        ...
        """
        return get_objects(self.project, Task, job_id=self.id, as_objects=as_objects, **query_params)
    ...
    def update_tasks(self, tasks, as_objects=True, **query_params):
        ...
        """
        return update_objects(self.project, tasks, job_id=self.id, as_objects=as_objects, **query_params)
