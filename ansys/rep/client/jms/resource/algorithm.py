...
class Algorithm(Object):
    ...
    def get_jobs(self, as_objects=True, **query_params):
        ...
        """
        return get_objects(self.project, Job, as_objects=as_objects, algorithm_id=self.id, **query_params)
    ...
    def get_selections(self, as_objects=True, **query_params):
        ...
        """
        return get_selections(self.project, as_objects=as_objects, algorithm_id=self.id, **query_params)
